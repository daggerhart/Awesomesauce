<?php
/**
 * Awesomesauce functions and definitions.
 *
...
if ( ! function_exists( 'awesomesauce_setup' ) ) :
/**
...
function awesomesauce_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'awesomesauce_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // awesomesauce_setup
